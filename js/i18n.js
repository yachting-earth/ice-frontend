...
const EN_INLINE = {
  ...
  "profile": {
    ...
    "sharingHeading": "Sharing with crew",
    "sharingHint": "Your phone and email are always visible to your ICE (In Case of Emergency) contact. Turn this on if your crew should be able to see them too.",
    "shareContactWithCrewLabel": "Share my phone and email with my crew",
    "sharingEnabled": "Your contact details are now shared with your crew.",
    "sharingDisabled": "Your contact details are no longer shared with your crew.",
    "sharingSaveFailed": "Could not save the sharing setting.",
