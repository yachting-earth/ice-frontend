...
const EN_INLINE = {
  ...
  "errors": {
    ...
    "ICE_CONTACT_IN_USE": "Can't delete this contact — it's assigned to an active or upcoming trip. Reassign that trip's ICE contact first.",
    ...
    "ACCOUNT_HAS_ACTIVE_TRIP": "Your account can't be deleted while you're the skipper or crew on a trip that's published or active. Cancel or complete the trip first.",
    "ACCOUNT_DELETION_PENDING": "This account has been deleted and can no longer be used.",
    "TRIP_NOT_ACTIVE": "SAR access can only be requested for an active trip.",
    "NO_EMERGENCY_TO_CONFIRM": "This trip has no emergency alarm to confirm.",
    "AUTO_ACCEPT_INVALID_DURATION": "Choose 1, 2 or 3 months, or turn auto-accept off.",
  ...
  "crewGdprPortal": {
    ...
    "notErasableLocked": "Your data is locked for maritime safety/traceability reasons following an emergency incident. It will be automatically purged 30 days after the trip was resolved.",
    ...
    "eraseKeptLocked": "{count} membership(s) on a trip with an emergency incident were kept for maritime safety/traceability reasons and will be purged automatically 30 days after the trip was resolved.",
  ...
  "profile": {
    ...
    "photoRemoveConfirm": "Are you sure you want to delete your profile photo?",
    "photoRemoveFailed": "Could not delete the photo.",
    "photoRemoved": "Your photo has been removed.",
    ...
    "emergencyContactHint": "Who search and rescue should call about you personally, separate from the ICE contacts alerted if a trip goes overdue.",
    "emergencyContactNameLabel": "Name",
    "emergencyContactPhoneLabel": "Phone",
    "emergencyContactRelationshipLabel": "Relationship",
    "emergencyContactRelationshipPlaceholder": "e.g. spouse, brother, friend",
    "emergencyContactSubmit": "Save emergency contact",
    "emergencyContactSaveFailed": "Could not save your emergency contact.",
    "emergencyContactSaved": "Emergency contact saved.",
    "medicalHeading": "Medical information",
    ...
    "medicalSubmit": "Save medical information",
    "medicalSaveFailed": "Could not save your medical information.",
    "medicalSaved": "Medical information saved.",
    "emailLabel": "Email",
    ...
    "gdprHint": "Request a summary of everything we've stored about you - account, vessels, ICE contacts and trips. The file is delivered immediately in machine-readable JSON format and is available for download for 7 days.",
    ...
    "deleteDeferred": "Your account has been deactivated and will be permanently deleted once your trip's retention period ends, on {date}. You've been signed out and can't log back in."
  },
  "telegramLink": {
  ...
  "crewInvite": {
    ...
    "iceContactHint": "Who search and rescue should call about you personally, if something happens. Saved to your profile.",
    "emergencyContactNameLabel": "Name",
    "emergencyContactPhoneLabel": "Phone",
    "emergencyContactRelationshipLabel": "Relationship",
    "emergencyContactRelationshipPlaceholder": "e.g. spouse, brother, friend",
    ...
    "readOnlyNotice": "This invitation is linked to an existing account, so your name, phone, date of birth, emergency contact and medical information were not changed. {loginLink} to edit them there.",
    "toOverview": "To your overview",
  ...
  "iceConfirm": {
    ...
    "policyNoteKeep": "Your account has now been created.",
  ...
  "ice": {
    "auto_accept": {
      "title": "Auto-accept new trips",
      "description": "When enabled, new trips you're assigned as ICE contact for are automatically confirmed without requiring your approval each time. You'll still be notified about every trip.",
      "enable": "Enable auto-accept",
      "disable": "Disable auto-accept",
      "duration_1_month": "1 month",
      "duration_2_months": "2 months",
      "duration_3_months": "3 months",
      "active_until": "Auto-accept is active until {date}.",
      "expired": "Auto-accept has expired.",
      "skipper_badge": "Auto-accept active"
    }
  },
  "icePortal": {
    ...
    "confirmEmergency": {
      "heading": "Confirm the alarm is resolved",
      "description": "If you've confirmed the skipper is safe, record a comment and confirm below - this clears the trip's write lock and lets the skipper resume managing it.",
      "commentLabel": "Comment (required)",
      "commentPlaceholder": "e.g. Called the skipper, they're safe and continuing.",
      "commentRequired": "Enter a comment before confirming.",
      "button": "Confirm alarm resolved",
      "confirmPrompt": "Confirm this trip's emergency alarm is resolved?",
      "confirmFailed": "Could not confirm the alarm.",
      "confirmed": "Emergency alarm confirmed resolved."
    },
    "skipper": {
      "heading": "Skipper",
  ...
  "admin": {
    ...
    "confirmDeleteRoute": "Delete this route by {skipper}? This cannot be undone.",
    "confirmDeleteVessel": "Delete the boat {name} (owner {owner}) and its photo? This cannot be undone.",
    "confirmDeleteIceContact": "Delete the ICE contact {name} added by {skipper}? This cannot be undone.",
    "routeDeleted": "The route has been deleted.",
    "vesselDeleted": "The boat has been deleted.",
    "iceContactDeleted": "The ICE contact has been deleted.",
    "deleteRouteFailed": "Could not delete the route.",
    "deleteVesselFailed": "Could not delete the boat.",
    "deleteIceContactFailed": "Could not delete the ICE contact.",
    "stats": {
      "users": "Users",
      "routes": "Routes",
      "vessels": "Vessels",
    ...
    "empty": {
      ...
      "trips": "No trips match the filter"
    },
    "table": {
      "adminHeader": "Admin",
      "created": "Created",
    ...
    "trips": {
      ...
      "unconfirmedIncidentOnly": "Unconfirmed incidents only",
      "loadFailed": "Could not fetch trips.",
      "pageInfo": "Page {page} of {totalPages} ({total} trips)",
      "incidentConfirmed": "Confirmed",
      "incidentUnconfirmed": "Unconfirmed incident",
      "table": {
        "vessel": "Vessel",
        "incident": "Incident"
      },
      "confirmEmergency": {
        "toggle": "Confirm alarm",
        "commentLabel": "Comment (required)",
        "commentPlaceholder": "e.g. Reached the skipper by phone via the marina, they are safe.",
        "commentRequired": "Enter a comment before confirming.",
        "button": "Confirm alarm resolved",
        "confirmPrompt": "Confirm this trip's emergency alarm is resolved?",
        "confirmFailed": "Could not confirm the alarm.",
  ...
  "tripDetail": {
    ...
    "confirmEmergency": {
      "heading": "Confirm the alarm is resolved",
      "ownerDescription": "This trip's ICE contact was alerted because you didn't check in on time. Confirming clears the write lock so you can continue managing the trip - it does not undo the fact that an alarm was raised.",
      "iceDescription": "You've been alerted about this trip. If you've confirmed the skipper is safe, record a comment and confirm below - this clears the trip's write lock and lets the skipper resume managing it.",
      "commentLabel": "Comment (required)",
      "commentPlaceholder": "e.g. Called the skipper, they're safe and continuing.",
      "commentRequired": "Enter a comment before confirming.",
      "button": "Confirm alarm resolved",
  ...
  "privacy": {
    ...
    "sections": [
      ...
      },
      {
        ...
        "list": [
          "Account data - email, name, phone, and a password (stored only as a bcrypt hash, never in plain text) - or, for crew invited only by email, a password-less profile that can be turned into a full account later",
          ...
          "Your personal emergency contact - name, phone, and relationship; who search and rescue should call about you specifically if something happens. Set once on your profile and used on every trip you're on - separate from the ICE contact below",
          "Medical information - optional, for search and rescue only (e.g. allergies, medications, conditions). Set once on your profile; never shown to the skipper or the ICE contact",
          "ICE (\"In Case of Emergency\") contact data - name, email, phone, and relationship to the skipper; who the system alerts if a trip goes overdue",
      ...
      },
      {
        ...
        "list": [
          ...
          "Explicit consent - your personal emergency contact and the ICE contact details",
          "Explicit consent, as a special category of health data under GDPR Article 9, plus vital interests - medical information, only ever disclosed to search and rescue authorities in a genuine emergency",
      ...
      },
      {
        ...
        "body": [
          ...
          "Registered user accounts and vessels are not touched by this process - only the trip's own data is. Your personal emergency contact and medical information live on your account rather than on any one trip, so they're kept for as long as your account exists, not just for that trip's 30 days.",
          "If you stop using your account, it is anonymised - not deleted - after 18 months of inactivity: we email a warning first, and if you haven't logged back in within 30 days of that warning, your name, phone, date of birth, emergency contact, medical information and photo are permanently cleared. The account record itself is kept, so your past trips still make sense, and logging in at any point cancels this. An account still needed for a trip in progress is never anonymised this way.",
          "You can delete your account at any time from your profile page - this is usually immediate. If you're still the skipper or crew on a trip that's published or active, deletion is refused until that trip is finished or cancelled. If your trip has just ended and is still inside its 30-day retention window, deletion is deferred instead: your account is deactivated immediately - you're signed out and can't log back in - and it's permanently removed once that window closes.",
      ...
      },
      {
        ...
        "items": [
          ...
          },
          {
            ...
            "a": "Yes, from your profile page - it's usually immediate. If you're still the skipper or crew on a trip that's published or active, deletion is refused until that trip is finished or cancelled. If your trip has just ended and is still inside its 30-day retention window, deletion is deferred instead: your account is deactivated straight away - you're signed out and can't log back in - and it's permanently removed once that window closes. This is separate from what happens if you simply stop using the app: after 18 months of inactivity your account is anonymised, not deleted, so past trip records still make sense."
          },
          {
  ...
  "changelog": {
    "title": "What's new",
    "intro": "See what's new in Yachting Earth ICE, one release at a time.",
    "sectionNew": "New",
    ...
    "entries": [
      ...
      },
      {
        ...
        "sections": {
          "new": [
            "Your emergency contact and medical information now live on your profile - set them once and they'll be there on every trip you join as crew, instead of having to re-enter them each time.",
            "If your emergency contact was alerted because a trip went overdue, you or your emergency contact can now confirm from the trip page that everything is fine, which lifts the write-lock placed on the trip after an alert."
          ],
          "improved": [
            "Deleting your account is clearer when a trip is involved: it's refused while you're still needed on a trip that's under way, and if only the standard data-retention window is in the way, it's deferred instead - you're signed out right away and the deletion finishes automatically once that window closes.",
            "Creating an account while accepting a crew invitation no longer asks you to verify your email address separately - clicking the link in the invitation already proved the address is yours.",
            "You can now remove your profile photo on its own, instead of only being able to replace it with a new one."
          ]
        }
      },
      {
      ...
      },
      {
        ...
        "sections": {
          "fixed": [
            "Deleting a trip that was still under way no longer leaves the boat counted as being on an active voyage - you can start a new trip for that vessel straight away, instead of being told one is already active."
          ]
        }
      },
      {
      ...
      },
      {
        ...
        "sections": {
          "improved": [
            "We've rolled out a few small design fixes to make the system clearer."
          ]
        }
      },
      {
      ...
      },
      {
        ...
        "sections": {
          "new": [
            "To keep the service reliable and fair for everyone, we've added limits on how quickly certain actions can be repeated - creating an account, starting a new trip, inviting crew, and general use of the app. Everyday use isn't affected; you'd only see a \"try again shortly\" message if one of these was repeated unusually fast."
          ]
        }
      },
      {
        ...
        "sections": {
          "improved": [
            "The trip list on your dashboard no longer has status-filter buttons above it — all of your trips now show right away, without needing to filter by draft, published, active, completed or cancelled."
          ]
        }
      },
      {
      ...
      },
      {
        ...
        "sections": {
          "improved": [
            "Until you've confirmed your email address, your dashboard no longer shows trip-planning buttons that wouldn't work yet, so it's clear that verifying your email is the first step.",
            "When something you're saving can't go through, the reason now appears right next to the button you pressed and scrolls into view, so it's much harder to miss on a long page."
          ],
          "fixed": [
            "If you move your expected arrival to a later time, we'll now remind you again as that new time approaches, instead of staying quiet because an earlier reminder had already been sent.",
            "Changing your password now signs you out on every other device, so a session left open elsewhere can't stay active afterwards.",
            "Once you confirm you've arrived safely after an alert has already gone out, your emergency contact is now sent the all-clear so they know you're accounted for.",
            "You can no longer remove an emergency contact that a live or planned trip still relies on, and in the rare case a trip is left with no reachable contact, we now alert you directly instead of failing quietly."
          ]
        }
      },
      {
        ...
        "sections": {
          "fixed": [
            "When you edit one of your boats, its current photo now appears in the form right away, so you can see what's on file before deciding whether to replace it.",
            "Once you confirm you've arrived safely, the finished trip now leaves your dashboard straight away and starts its automatic 30-day clean-up, instead of lingering in your list.",
            "Long entries in the read-only trip view your emergency and rescue contacts see now wrap neatly instead of running past the edge of the card."
          ]
        }
      },
      {
      ...
      },
      {
        ...
        "sections": {
          "improved": [
            "Your emergency contacts now choose for themselves how they'd like to be reached - by email or Telegram - when they confirm, and alerts always go to the contact details they keep up to date on their own account.",
            "The language selector is now always visible on the sign-in and landing pages and in the top menu, so you can switch language at any time.",
            "The Telegram linking option on your profile now appears only when you choose Telegram as your notification channel, keeping the page uncluttered."
          ],
          "fixed": [
            "If an emergency contact who has their own account closes it, they're now clearly deactivated on your list instead of quietly staying there - just re-invite them when you want to use them for a trip again."
          ]
        }
      },
      {
      ...
      },
      {
        ...
        "sections": {
          "new": [
            "Yachting Earth ICE is now available in five languages - English, Swedish, French, Italian and Spanish - so you and your crew can use it in whichever language feels most natural."
          ],
          "improved": [
            "Once your emergency contact has been alerted, crew photos are now locked along with the rest of the trip, so nothing about it can be changed while help may be on the way.",
            "The site footer, with its quick links and version number, now appears on every page, whether or not you're signed in.",
            "We've tidied up the top menu: Blog and FAQ now live in the footer, keeping the main navigation focused on your trips."
          ]
        }
      },
      {
        ...
        "sections": {
          "new": [
            "Your trip now locks automatically once your emergency contact has been alerted, so nothing important can be changed by accident while help may be on the way.",
            "You can add private medical information for each crew member - visible only to search-and-rescue teams in a real emergency, never to you or your emergency contact.",
            "Every trip now has exactly one clearly assigned emergency contact, so it's always obvious who gets notified if something goes wrong.",
            "Overdue trips are now highlighted on your dashboard, so you can see at a glance if a trip needs attention.",
            "Save your regular crew, vessels and routes once and reuse them next time you plan a trip - no need to type the same details again.",
            "This \"What's new\" page, and a version number in the footer so you can always see which version you're using."
          ]
        }
      },
      {
        ...
        "sections": {
          "new": [
            "Yachting Earth ICE launches: register your trip and vessel, plan your route, and invite your crew.",
            "Add an emergency contact who is notified automatically if you don't check in on time.",
            "Your emergency contact and rescue services can view a simple, read-only summary of your trip if it's ever needed.",
            "Your trip information is automatically and permanently deleted a set time after your trip ends, to protect your privacy.",
